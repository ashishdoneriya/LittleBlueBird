        ...
        if (controller != null) {
          updateModel = function(value, picker) {
            return $scope.$apply(function() {
              return controller.$setViewValue($( "#datepicker" ).datepicker("getDate"));
            });
          };
          ...
          controller.$render = function() {
            originalRender();
            return $( "#datepicker" ).datepicker("setDate", controller.$viewValue);
          };
        }
        return $( "#datepicker" ).datepicker($scope.uiDate);
      }
    };
  });
