...
var app = angular.module('project', ['UserModule', 'CircleModule', 'GiftModule', 'datetime', 'FacebookModule']).
  config(function($routeProvider, $locationProvider, $rootScopeProvider, $cookieStoreProvider){
    ...
    $routeProvider
      ...
      .when('/emailit', {templates: {layout: 'home', one: 'partials/emailMyUsernameAndPassword.html', two: 'partials/loginWithFacebook.html', three:'partials/LittleBlueBird.html', four:'partials/navbar-nli.html', five:'partials/carousel.html', six:'partials/mobilebanner.html'}})
      ...
      .when('/home', {templates: {layout: 'home', one: 'partials/loginWithLittleBlueBird.html', two: 'partials/loginWithFacebook.html', three:'partials/LittleBlueBird.html', four:'partials/navbar-nli.html', five:'partials/carousel.html', six:'partials/mobilebanner.html'}})
      ...
      .when('/register', {templates: {layout: 'home', one: 'partials/register.html', two: 'partials/loginWithFacebook.html', three:'partials/LittleBlueBird.html', four:'partials/navbar-nli.html', five:'partials/carousel.html', six:'partials/mobilebanner.html'}})
      ...
      .when('/', {templates: {layout: 'home', one: 'partials/loginWithLittleBlueBird.html', two: 'partials/loginWithFacebook.html', three:'partials/LittleBlueBird.html', four:'partials/navbar-nli.html', five:'partials/carousel.html', six:'partials/mobilebanner.html'}})
